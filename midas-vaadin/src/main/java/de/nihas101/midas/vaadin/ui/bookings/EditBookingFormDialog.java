...
public class EditBookingFormDialog extends BookingFormDialog {
    ...
    private void setupFooter(final HorizontalLayout buttonLayout) {
    ...
    private void save() {
        ...
        if (this.shareholderLock != null && selectedShareholder != null && booking != null && booking.getDate() != null) {
